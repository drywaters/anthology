...
func seedLocalItems() []items.Item {
	...
	return []items.Item{
		...
		// Games (4 items)
		{
			...
			AgeGroup:    "Everyone 10+",
			Description: "A farming simulation RPG where you inherit your grandfather's old farm plot.",
		...
		},
		{
			...
			Notes:       "Beautiful artwork and relaxing gameplay.",
