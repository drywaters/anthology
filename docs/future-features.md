...
- **Series & collections:** Group items into sets (e.g., book series, movie trilogies) to maintain logical relationships beyond alphabetical sorting. (DONE)
...
## Data portability
- **Export to CSV/JSON:** Allow users to export their entire catalog for backups, personal analysis, or migration to other tools. (DONE)
